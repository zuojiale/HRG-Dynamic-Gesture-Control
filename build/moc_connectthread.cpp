...
QT_MOC_LITERAL(1, 14, 11), // "S_openedHRG"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11) // "F_openedHRG"

    },
    "ConnectThread\0S_openedHRG\0\0F_openedHRG"
};
...
void ConnectThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConnectThread *_t = static_cast<ConnectThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->S_openedHRG(); break;
        case 1: _t->F_openedHRG(); break;
        default: ;
        }
        ...
        {
            typedef void (ConnectThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ConnectThread::S_openedHRG)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ConnectThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ConnectThread::F_openedHRG)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject ConnectThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ConnectThread.data,
      qt_meta_data_ConnectThread,  qt_static_metacall, nullptr, nullptr}
};
...
void *ConnectThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConnectThread.stringdata0))
        return static_cast<void*>(const_cast< ConnectThread*>(this));
...
// SIGNAL 0
void ConnectThread::S_openedHRG()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ConnectThread::F_openedHRG()
{
